...
Item {
    ...
    readonly property real dotSize: root.width * (11.11 / 200)
    ...
    Rectangle {
        ...
        x: root.width * (47.22 / 200) - root.dotSize / 2
        y: root.height * 0.5 - root.dotSize / 2
        width: root.dotSize
        height: root.dotSize
    ...
    Rectangle {
        visible: root.glyph !== "off"
        x: root.width * (152.78 / 200) - root.dotSize / 2
        y: root.height * 0.5 - root.dotSize / 2
        width: root.dotSize
        height: root.dotSize
        radius: root.dotSize / 2
